...
This is exactly the kind of thing we hunt for, the cheaper tool quietly doing the expensive one's job.
...
That gap, between using it and using it well, is the entire opportunity.

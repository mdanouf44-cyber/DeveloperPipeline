#!/usr/bin/env python3
"""Generate Mohammad Anouf Saani cream-design carousel slides (typography-forward) for both
...
<div class="hright"><div class="fw">Mohammad Anouf Saani / 2026</div><div class="badge">{num}</div></div></div>
...
def build(slide, accent, kicker):
    ...
    if slide.get("cta"):
        bottom = '<div class="pill">follow Mohammad Anouf Saani (www.linkedin.com/in/mohammad-anouf-saani) for daily <em>frameworks.</em></div>'
    else:
...
write_set("carousel-branded", "#D9785B", "Mohammad Anouf Saani / build in public", BRANDED)
write_set("carousel-performance", "#E16259", "Mohammad Anouf Saani / founder story", PERF)
print("done")

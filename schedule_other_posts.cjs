...
(async () => {
  ...
  try {
    ...
    for (const post of posts) {
      ...
      console.log(`==========================================`);
      const prefix = `./slack_downloads/post_other_${post.id}`;

...
| `carousel-routine/brand-kit.html` | Mohammad Anouf Saani brand design system HTML |
...
| File | Purpose |
|------|---------|
| `send_to_telegram.py` | Master Telegram delivery: texts + PDF + PNG |
| `send_telegram_message.py` | Simple text message to Telegram |
